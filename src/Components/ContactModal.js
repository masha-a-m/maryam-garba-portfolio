...
const About = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-8">
      ...
      {/* Footer */}
      <footer className="curved-footer">
        <p>Copyright © 2025 · Whispering Codes</p>
        <div className="right-side">
          <a
            href="https://facebook.com/whisperingcodes/" 
            aria-label="Facebook"
            target="_blank"
          ...
          <a
            href="https://instagram.com/whisperingcodes/" 
          ...
          <a
            href="https://pinterest.com/maryam10101/" 
          ...
          <a
            href="https://tiktok.com/whisperingcodes/" 
            aria-label="Dribbble"
            target="_blank"
            rel="noopener noreferrer"
